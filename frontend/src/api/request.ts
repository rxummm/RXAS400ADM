...
const ERROR_CODE_I18N_MAP: Record<number, string> = {
  ...
  20008: 'error.AS400_COMMAND_BUSY',
  // 发布 (30000+)
  ...
  // 邮件 (130000+)
  130001: 'error.EMAIL_SMTP_NOT_CONFIGURED',
  130002: 'error.EMAIL_SEND_FAILED',
  130003: 'error.EMAIL_GROUP_NOT_FOUND',
  130004: 'error.EMAIL_RECIPIENT_EXISTS',
  // 操作 (140000+)
  140001: 'error.OPERATION_NOT_FOUND',
  140002: 'error.OPERATION_TYPE_UNKNOWN',
  140003: 'error.OPERATION_STATUS_CONFLICT',
  140004: 'error.OPERATION_STEP_FAILED',
  140005: 'error.OPERATION_TIMEOUT',
  140006: 'error.OPERATION_MAX_RETRY',
  140007: 'error.OPERATION_CANCELLED',
  140008: 'error.OPERATION_FORBIDDEN',
  140009: 'error.OPERATION_CONFIRMATION_REQUIRED',
  140010: 'error.SERVICE_UNAVAILABLE',
  140011: 'error.CONFLICT',
}
