...
class DocServiceTest {
    ...
    void setUp() {
        ...
        DocStorageService storageService = new DocStorageService(clientProvider, docMapper);
        service = new DocService(docMapper, templateMapper, templateService, versionService, storageService);
    }
    ...
    @Test
    void approveTextDoc_shouldAutoPublishToIfs() throws Exception {
